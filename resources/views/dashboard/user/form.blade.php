                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" id="admi" name="lnevel" value="1" {{ isset($user) && $user->level == 1 ? 'checked' : '' }}>
                            <label for="admin">Admin</label>&nbsp; &nbsp;
                            <input type="radio" id="siswa" name="level" value="2" {{ isset($user) && $user->level == 2 ? 'checked' : '' }}>
                        ...
                        <div class="form-group mt-4">
                            ...
                            <button type="submit" class="btn btn-success btn-sm m-2">{{$button}}</button>
                        </div>
